...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        About = new QAction(QWMainWind);
        About->setObjectName("About");
        About->setCheckable(true);
        About->setChecked(true);
        QIcon icon11;
        icon11.addFile(QString::fromUtf8("images/aliens-fill.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        About->setIcon(icon11);
        About->setMenuRole(QAction::MenuRole::TextHeuristicRole);
        centralWidget = new QWidget(QWMainWind);
        centralWidget->setObjectName("centralWidget");
        txtEdit = new QTextEdit(centralWidget);
        txtEdit->setObjectName("txtEdit");
        txtEdit->setGeometry(QRect(50, 15, 396, 171));
        QFont font1;
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        About->setText(QCoreApplication::translate("QWMainWind", "\345\205\263\344\272\216", nullptr));
